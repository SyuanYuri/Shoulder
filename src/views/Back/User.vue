        ...
        <div class="modal-content">
          ...
          <div class="modal-footer justify-content-between">
            ...
            <div class="ms-auto">
              ...
              <button type="button" class="btn add-btn ms-2" @click="addUser()">
                新增
              </button>
            </div>
          </div>
